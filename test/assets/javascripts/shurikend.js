      ...
      add: function(handleObj) {
        ...
        if (this.nodeType === 1 && this.tagName.toLowerCase() === "img" && this.src !== "") {
          if (options.forceLoad) {
            ...
            return handleObj.handler.apply(this, arguments_);
          } else {
  ...
  (function($, window, document, undefined_) {
    ...
    cl = {
      ...
      swipe_events: function() {
        return $(document).bind("swipeleft", "ul[data-clearing]", function(e) {
          return cl.nav(e, "next");
      ...
      assemble: function($li) {
        var $el, data, grid, settings, wrapper;
        $el = $li.parent();
        settings = $el.data("fndtn.clearing.settings");
        grid = $el.detach();
        data = {
      ...
      open: function($image, current, target) {
        var container, image, root, visible_image;
        ...
        if (!cl.locked()) {
          ...
          return image.loaded(function() {
            ...
            this.center(image);
            return this.shift(current, target, function() {
      ...
      close: function(e) {
        var container, root, visible_image;
        e.preventDefault();
      ...
      keydown: function(e) {
        ...
        if (e.which === 27) {
          return $("a.clearing-close").trigger("click");
        }
      },
      nav: function(e, direction) {
        ...
        clearing = $(".clearing-blackout").find("ul[data-clearing]");
        e.preventDefault();
        return this.go(clearing, direction);
      },
      resize: function() {
        var image;
        image = $(".clearing-blackout .visible-img").find("img");
        if (image.length > 0) {
          return cl.center(image);
        }
      },
      ...
      update_paddles: function(target) {
        ...
        if (target.prev().length > 0) {
          return visible_image.find(".clearing-main-left").removeClass("disabled");
        } else {
          return visible_image.find(".clearing-main-left").addClass("disabled");
        }
      },
      load: function($image) {
        var href;
      ...
      preload: function($image) {
        ...
        return this.img($image.closest("li").prev());
      },
      img: function(img) {
        var new_a, new_img;
        if (img.length > 0) {
          ...
          new_a = img.find("a");
          if (new_a.length > 0) {
            return new_img.src = new_a.attr("href");
          } else {
            return new_img.src = img.find("img").attr("src");
          }
        }
      },
      caption: function(container, $image) {
        ...
        if (caption) {
          return container.text(caption).show();
        } else {
          return container.text("").hide();
        }
      },
      go: function($ul, direction) {
        ...
        if (target.length > 0) {
          return target.find("img").trigger("click", [current, target]);
        }
      },
      shift: function(current, target, callback) {
        var clearing, direction, left, old_index, skip_shift, width;
      ...
      direction: function($el, current, target) {
        var li_width, lis, response, target_index, up_count;
        lis = $el.find("li");
    ...
    $.fn.foundationClearing = function(method) {
      if (cl[method]) {
        return cl[method].apply(this, Array.prototype.slice.call(arguments_, 1));
      } else if (typeof method === "object" || !method) {
        return cl.init.apply(this, arguments_);
      } else {
        return $.error("Method " + method + " does not exist on jQuery.foundationClearing");
      }
    };
    return (function($) {
      $.fn.loaded = function(callback, userSettings) {
        var $images, bindLoad, loaded, options, unloadedImages;
        loaded = function() {
          unloadedImages -= 1;
          return !unloadedImages && callback();
        };
        bindLoad = function() {
          var param, src;
          ...
          if ($.browser.msie) {
            ...
            return this.attr("src", src + param);
          }
        };
        ...
        return $images.each(function() {
          ...
          if (this.complete || this.readyState === 4) {
            ...
            return bindLoad.call($this);
          }
        });
      };
      return $.fn.loaded.defaults = {
        cachePrefix: "random"
      };
    })(jQuery);
  })(jQuery, this, this.document);
